...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('lecturer.attendance-data.index') }}">Presensi</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="session-info-item">
                                    <div class="session-info-label">Mata Kuliah:</div>
                                    <div>{{ $session->classSchedule->course->name }}</div>
                                </div>
                                <div class="session-info-item">
                                    <div class="session-info-label">Kelas:</div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="alert alert-info">
                                ...
                                <strong>Catatan:</strong> Total jam untuk setiap mahasiswa harus sama dengan
                                {{ $session->total_hours }}.
                                Ketika
                                Anda menambah satu nilai, sistem akan secara otomatis mengurangi dari nilai lainnya.
                            </div>
    ...
    <script>
        $(function() {
            ...
            $('#saveAllBtn').click(function() {
                ...
                $.ajax({
                    url: "{{ route('lecturer.attendance-data.update-status') }}",
                    method: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
                        attendances: allData
